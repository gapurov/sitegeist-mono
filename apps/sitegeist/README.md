...
Bumps the version in `static/manifest.chrome.json`, commits, runs a local build against the release commit, tags, and pushes. GitHub Actions builds the extension and creates a release at [github.com/gapurov/sitegeist-remixed/releases](https://github.com/gapurov/sitegeist-remixed/releases).
